...
%prep
%setup -q -n harfbuzz-1.8.2
pushd ..
cp -a harfbuzz-1.8.2 build32
popd
pushd ..
cp -a harfbuzz-1.8.2 buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1530748963
export AR=gcc-ar
...
%configure --disable-static --with-icu=yes --with-glib --with-freetype --with-cairo --with-icu --enable-introspection   --libdir=/usr/lib64/haswell
make  %{?_smp_mflags}
popd
%install
export SOURCE_DATE_EPOCH=1530748963
...
cp src/hb-ucdn/COPYING %{buildroot}/usr/share/doc/harfbuzz/src_hb-ucdn_COPYING
cp test/shaping/data/in-house/COPYING %{buildroot}/usr/share/doc/harfbuzz/test_shaping_data_in-house_COPYING
cp test/shaping/data/text-rendering-tests/COPYING %{buildroot}/usr/share/doc/harfbuzz/test_shaping_data_text-rendering-tests_COPYING
cp test/shaping/texts/in-house/shaper-indic/indic/script-gujarati/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-gujarati_utrrs_LICENSE
cp test/shaping/texts/in-house/shaper-indic/indic/script-kannada/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-kannada_utrrs_LICENSE
cp test/shaping/texts/in-house/shaper-indic/indic/script-oriya/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-oriya_utrrs_LICENSE
cp test/shaping/texts/in-house/shaper-indic/indic/script-tamil/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-tamil_utrrs_LICENSE
cp test/shaping/texts/in-house/shaper-indic/indic/script-telugu/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-telugu_utrrs_LICENSE
cp test/shaping/texts/in-house/shaper-indic/indic/script-assamese/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-assamese_utrrs_LICENSE
cp test/shaping/texts/in-house/shaper-indic/indic/script-devanagari/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-devanagari_utrrs_LICENSE
cp test/shaping/texts/in-house/shaper-indic/indic/script-gurmukhi/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-gurmukhi_utrrs_LICENSE
cp test/shaping/texts/in-house/shaper-indic/indic/script-bengali/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-bengali_utrrs_LICENSE
cp test/shaping/texts/in-house/shaper-indic/indic/script-sinhala/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-sinhala_utrrs_LICENSE
cp test/shaping/texts/in-house/shaper-indic/indic/script-malayalam/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-malayalam_utrrs_LICENSE
pushd ../build32/
%make_install32
...
%files
%defattr(-,root,root,-)
/usr/lib64/haswell/cmake/harfbuzz/harfbuzz-config.cmake
...
/usr/include/harfbuzz/hb-subset-glyf.hh
/usr/include/harfbuzz/hb-subset-plan.hh
/usr/include/harfbuzz/hb-subset-private.hh
...
/usr/lib64/haswell/libharfbuzz-icu.so
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/haswell/libharfbuzz-icu.so.0
/usr/lib64/haswell/libharfbuzz-icu.so.0.10800.2
/usr/lib64/haswell/libharfbuzz-subset.so.0
/usr/lib64/haswell/libharfbuzz-subset.so.0.10800.2
/usr/lib64/haswell/libharfbuzz.so.0
/usr/lib64/haswell/libharfbuzz.so.0.10800.2
/usr/lib64/libharfbuzz-icu.so.0
/usr/lib64/libharfbuzz-icu.so.0.10800.2
/usr/lib64/libharfbuzz-subset.so.0
/usr/lib64/libharfbuzz-subset.so.0.10800.2
/usr/lib64/libharfbuzz.so.0
/usr/lib64/libharfbuzz.so.0.10800.2

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libharfbuzz-icu.so.0
/usr/lib32/libharfbuzz-icu.so.0.10800.2
/usr/lib32/libharfbuzz-subset.so.0
/usr/lib32/libharfbuzz-subset.so.0.10800.2
/usr/lib32/libharfbuzz.so.0
/usr/lib32/libharfbuzz.so.0.10800.2

%files license
%defattr(-,root,root,-)
/usr/share/doc/harfbuzz/COPYING
/usr/share/doc/harfbuzz/src_hb-ucdn_COPYING
/usr/share/doc/harfbuzz/test_shaping_data_in-house_COPYING
/usr/share/doc/harfbuzz/test_shaping_data_text-rendering-tests_COPYING
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-assamese_utrrs_LICENSE
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-bengali_utrrs_LICENSE
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-devanagari_utrrs_LICENSE
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-gujarati_utrrs_LICENSE
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-gurmukhi_utrrs_LICENSE
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-kannada_utrrs_LICENSE
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-malayalam_utrrs_LICENSE
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-oriya_utrrs_LICENSE
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-sinhala_utrrs_LICENSE
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-tamil_utrrs_LICENSE
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_indic_script-telugu_utrrs_LICENSE
