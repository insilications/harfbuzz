...
Source0  : https://www.freedesktop.org/software/harfbuzz/release/harfbuzz-2.6.2.tar.xz
...
%prep
%setup -q -n harfbuzz-2.6.2
pushd ..
cp -a harfbuzz-2.6.2 build32
popd
pushd ..
cp -a harfbuzz-2.6.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1569901476
...
/usr/lib64/haswell/libharfbuzz-subset.so.0.20600.2
/usr/lib64/haswell/libharfbuzz.so.0
/usr/lib64/haswell/libharfbuzz.so.0.20600.2
/usr/lib64/libharfbuzz-icu.so.0
/usr/lib64/libharfbuzz-icu.so.0.20600.2
/usr/lib64/libharfbuzz-subset.so.0
/usr/lib64/libharfbuzz-subset.so.0.20600.2
/usr/lib64/libharfbuzz.so.0
/usr/lib64/libharfbuzz.so.0.20600.2

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libharfbuzz-icu.so.0
/usr/lib32/libharfbuzz-icu.so.0.20600.2
/usr/lib32/libharfbuzz-subset.so.0
/usr/lib32/libharfbuzz-subset.so.0.20600.2
/usr/lib32/libharfbuzz.so.0
/usr/lib32/libharfbuzz.so.0.20600.2
