...
Source0  : https://www.freedesktop.org/software/harfbuzz/release/harfbuzz-1.8.7.tar.bz2
...
%prep
%setup -q -n harfbuzz-1.8.7
pushd ..
cp -a harfbuzz-1.8.7 build32
popd
pushd ..
cp -a harfbuzz-1.8.7 buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1533825900
export AR=gcc-ar
...
cp test/shaping/texts/in-house/shaper-indic/script-assamese/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-assamese_utrrs_LICENSE
cp test/shaping/texts/in-house/shaper-indic/script-bengali/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-bengali_utrrs_LICENSE
cp test/shaping/texts/in-house/shaper-indic/script-devanagari/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-devanagari_utrrs_LICENSE
cp test/shaping/texts/in-house/shaper-indic/script-gujarati/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-gujarati_utrrs_LICENSE
cp test/shaping/texts/in-house/shaper-indic/script-gurmukhi/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-gurmukhi_utrrs_LICENSE
cp test/shaping/texts/in-house/shaper-indic/script-kannada/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-kannada_utrrs_LICENSE
cp test/shaping/texts/in-house/shaper-indic/script-malayalam/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-malayalam_utrrs_LICENSE
cp test/shaping/texts/in-house/shaper-indic/script-oriya/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-oriya_utrrs_LICENSE
cp test/shaping/texts/in-house/shaper-indic/script-sinhala/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-sinhala_utrrs_LICENSE
cp test/shaping/texts/in-house/shaper-indic/script-tamil/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-tamil_utrrs_LICENSE
cp test/shaping/texts/in-house/shaper-indic/script-telugu/utrrs/LICENSE %{buildroot}/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-telugu_utrrs_LICENSE
pushd ../build32/
%make_install32
...
/usr/lib64/haswell/libharfbuzz-subset.so.0.10800.7
/usr/lib64/haswell/libharfbuzz.so.0
/usr/lib64/haswell/libharfbuzz.so.0.10800.7
/usr/lib64/libharfbuzz-icu.so.0
/usr/lib64/libharfbuzz-icu.so.0.10800.7
/usr/lib64/libharfbuzz-subset.so.0
/usr/lib64/libharfbuzz-subset.so.0.10800.7
/usr/lib64/libharfbuzz.so.0
/usr/lib64/libharfbuzz.so.0.10800.7

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libharfbuzz-icu.so.0
/usr/lib32/libharfbuzz-icu.so.0.10800.7
/usr/lib32/libharfbuzz-subset.so.0
/usr/lib32/libharfbuzz-subset.so.0.10800.7
/usr/lib32/libharfbuzz.so.0
/usr/lib32/libharfbuzz.so.0.10800.7
...
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-assamese_utrrs_LICENSE
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-bengali_utrrs_LICENSE
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-devanagari_utrrs_LICENSE
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-gujarati_utrrs_LICENSE
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-gurmukhi_utrrs_LICENSE
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-kannada_utrrs_LICENSE
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-malayalam_utrrs_LICENSE
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-oriya_utrrs_LICENSE
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-sinhala_utrrs_LICENSE
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-tamil_utrrs_LICENSE
/usr/share/doc/harfbuzz/test_shaping_texts_in-house_shaper-indic_script-telugu_utrrs_LICENSE
