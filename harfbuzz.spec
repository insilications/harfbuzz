...
Source0  : https://www.freedesktop.org/software/harfbuzz/release/harfbuzz-2.6.3.tar.xz
...
%prep
%setup -q -n harfbuzz-2.6.3
pushd ..
cp -a harfbuzz-2.6.3 build32
popd
pushd ..
cp -a harfbuzz-2.6.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572320376
...
cp %{_builddir}/harfbuzz-2.6.3/COPYING %{buildroot}/usr/share/package-licenses/harfbuzz/04542733e710db7b4d9d871984846b31b8b907ac
cp %{_builddir}/harfbuzz-2.6.3/test/shaping/data/aots/COPYING %{buildroot}/usr/share/package-licenses/harfbuzz/f8c8a69b50f2eb0c11c277dfff1f4c69a014a24a
cp %{_builddir}/harfbuzz-2.6.3/test/shaping/data/in-house/COPYING %{buildroot}/usr/share/package-licenses/harfbuzz/6ee2d8efdf85d9dba10ec1d9f4fb821baf2db4f4
cp %{_builddir}/harfbuzz-2.6.3/test/shaping/data/text-rendering-tests/COPYING %{buildroot}/usr/share/package-licenses/harfbuzz/2f52d0b1bf8ddf82117ba37aefc4d5945392c005
cp %{_builddir}/harfbuzz-2.6.3/test/shaping/texts/in-house/shaper-indic/script-assamese/utrrs/LICENSE %{buildroot}/usr/share/package-licenses/harfbuzz/d1b9f10b93a02a3b2ada5dafbe7a55420d2a007a
cp %{_builddir}/harfbuzz-2.6.3/test/shaping/texts/in-house/shaper-indic/script-bengali/utrrs/LICENSE %{buildroot}/usr/share/package-licenses/harfbuzz/d1b9f10b93a02a3b2ada5dafbe7a55420d2a007a
cp %{_builddir}/harfbuzz-2.6.3/test/shaping/texts/in-house/shaper-indic/script-devanagari/utrrs/LICENSE %{buildroot}/usr/share/package-licenses/harfbuzz/d1b9f10b93a02a3b2ada5dafbe7a55420d2a007a
cp %{_builddir}/harfbuzz-2.6.3/test/shaping/texts/in-house/shaper-indic/script-gujarati/utrrs/LICENSE %{buildroot}/usr/share/package-licenses/harfbuzz/d1b9f10b93a02a3b2ada5dafbe7a55420d2a007a
cp %{_builddir}/harfbuzz-2.6.3/test/shaping/texts/in-house/shaper-indic/script-gurmukhi/utrrs/LICENSE %{buildroot}/usr/share/package-licenses/harfbuzz/d1b9f10b93a02a3b2ada5dafbe7a55420d2a007a
cp %{_builddir}/harfbuzz-2.6.3/test/shaping/texts/in-house/shaper-indic/script-kannada/utrrs/LICENSE %{buildroot}/usr/share/package-licenses/harfbuzz/d1b9f10b93a02a3b2ada5dafbe7a55420d2a007a
cp %{_builddir}/harfbuzz-2.6.3/test/shaping/texts/in-house/shaper-indic/script-malayalam/utrrs/LICENSE %{buildroot}/usr/share/package-licenses/harfbuzz/d1b9f10b93a02a3b2ada5dafbe7a55420d2a007a
cp %{_builddir}/harfbuzz-2.6.3/test/shaping/texts/in-house/shaper-indic/script-oriya/utrrs/LICENSE %{buildroot}/usr/share/package-licenses/harfbuzz/d1b9f10b93a02a3b2ada5dafbe7a55420d2a007a
cp %{_builddir}/harfbuzz-2.6.3/test/shaping/texts/in-house/shaper-indic/script-sinhala/utrrs/LICENSE %{buildroot}/usr/share/package-licenses/harfbuzz/d1b9f10b93a02a3b2ada5dafbe7a55420d2a007a
cp %{_builddir}/harfbuzz-2.6.3/test/shaping/texts/in-house/shaper-indic/script-tamil/utrrs/LICENSE %{buildroot}/usr/share/package-licenses/harfbuzz/d1b9f10b93a02a3b2ada5dafbe7a55420d2a007a
cp %{_builddir}/harfbuzz-2.6.3/test/shaping/texts/in-house/shaper-indic/script-telugu/utrrs/LICENSE %{buildroot}/usr/share/package-licenses/harfbuzz/d1b9f10b93a02a3b2ada5dafbe7a55420d2a007a
pushd ../build32/
%make_install32
...
/usr/lib64/haswell/libharfbuzz-subset.so.0.20600.3
/usr/lib64/haswell/libharfbuzz.so.0
/usr/lib64/haswell/libharfbuzz.so.0.20600.3
/usr/lib64/libharfbuzz-icu.so.0
/usr/lib64/libharfbuzz-icu.so.0.20600.3
/usr/lib64/libharfbuzz-subset.so.0
/usr/lib64/libharfbuzz-subset.so.0.20600.3
/usr/lib64/libharfbuzz.so.0
/usr/lib64/libharfbuzz.so.0.20600.3

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libharfbuzz-icu.so.0
/usr/lib32/libharfbuzz-icu.so.0.20600.3
/usr/lib32/libharfbuzz-subset.so.0
/usr/lib32/libharfbuzz-subset.so.0.20600.3
/usr/lib32/libharfbuzz.so.0
/usr/lib32/libharfbuzz.so.0.20600.3

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/harfbuzz/04542733e710db7b4d9d871984846b31b8b907ac
