...
Source0  : https://www.freedesktop.org/software/harfbuzz/release/harfbuzz-1.8.8.tar.bz2
...
%prep
%setup -q -n harfbuzz-1.8.8
pushd ..
cp -a harfbuzz-1.8.8 build32
popd
pushd ..
cp -a harfbuzz-1.8.8 buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1534339743
export AR=gcc-ar
...
/usr/lib64/haswell/libharfbuzz-subset.so.0.10800.8
/usr/lib64/haswell/libharfbuzz.so.0
/usr/lib64/haswell/libharfbuzz.so.0.10800.8
/usr/lib64/libharfbuzz-icu.so.0
/usr/lib64/libharfbuzz-icu.so.0.10800.8
/usr/lib64/libharfbuzz-subset.so.0
/usr/lib64/libharfbuzz-subset.so.0.10800.8
/usr/lib64/libharfbuzz.so.0
/usr/lib64/libharfbuzz.so.0.10800.8

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libharfbuzz-icu.so.0
/usr/lib32/libharfbuzz-icu.so.0.10800.8
/usr/lib32/libharfbuzz-subset.so.0
/usr/lib32/libharfbuzz-subset.so.0.10800.8
/usr/lib32/libharfbuzz.so.0
/usr/lib32/libharfbuzz.so.0.10800.8
