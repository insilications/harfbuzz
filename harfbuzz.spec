...
Source0  : https://www.freedesktop.org/software/harfbuzz/release/harfbuzz-2.3.1.tar.bz2
...
%prep
%setup -q -n harfbuzz-2.3.1
pushd ..
cp -a harfbuzz-2.3.1 build32
popd
pushd ..
cp -a harfbuzz-2.3.1 buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1549124405
export AR=gcc-ar
...
/usr/lib64/haswell/libharfbuzz-subset.so.0.20301.0
/usr/lib64/haswell/libharfbuzz.so.0
/usr/lib64/haswell/libharfbuzz.so.0.20301.0
...
/usr/lib32/libharfbuzz-icu.so.0.20301.0
/usr/lib32/libharfbuzz-subset.so.0
/usr/lib32/libharfbuzz-subset.so.0.20301.0
/usr/lib32/libharfbuzz.so.0
/usr/lib32/libharfbuzz.so.0.20301.0
